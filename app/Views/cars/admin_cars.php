...
<div class="admin-shell">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-5">
        ...
        <div class="d-flex flex-wrap align-items-center gap-2">
            <!-- Owner Filter -->
            <form action="<?php echo BASE_URL; ?>admin/cars.php" method="GET" class="d-flex align-items-center gap-2 me-md-3">
            ...
            <?php if($owner_id_filter): ?>
                <a href="<?php echo BASE_URL; ?>admin/cars.php" class="btn btn-outline-secondary rounded-pill px-4">Clear</a>
            <?php endif; ?>
        </div>
    </div>
                        ...
                        <?php if($cars && $cars->num_rows > 0): ?>
                            <?php while($row = $cars->fetch_assoc()): ?>
                                <tr>
                                    <td class="ps-4">
                                        <?php if($row['image']): ?>
                                            <img src="<?php echo BASE_URL; ?>uploads/<?php echo htmlspecialchars($row['image']); ?>" width="60" height="40" class="rounded-3 shadow-sm object-fit-cover" alt="Car">
                                        <?php else: ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr><td colspan="7" class="text-center py-4 text-muted">No cars found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
